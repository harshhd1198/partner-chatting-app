...
import com.example.chatingapp.databinding.ActivityChatDetailBinding;
          ...
          database.getReference().child("chats")
                  ...
                  .addOnSuccessListener(new OnSuccessListener<Void>() {
                      ...
                      public void onSuccess(Void unused) {
                          database.getReference().child("chats")
                                  .child(reciverRoom).push().setValue(model).addOnSuccessListener(new OnSuccessListener<Void>() {
                              @Override
